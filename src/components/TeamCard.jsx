        ...
        <div className="relative">
          ...
          {isPlayoff && (
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              className="absolute -top-1 -right-1 w-4 h-4 sm:w-5 sm:h-5 bg-accent-green rounded-full flex items-center justify-center text-xs font-bold text-bg-primary"
            >
              {rank + 1}
            </motion.div>
          )}
